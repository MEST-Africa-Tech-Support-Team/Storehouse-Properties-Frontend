            ...
            <tbody className="divide-y divide-[#E5E7EB]">
              {filteredProperties.length > 0 ? (
                filteredProperties.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm font-bold text-[#1a1a1a]">
                      ${item.price}
                      <span className="text-[#6B7280] font-normal">/night</span>
                    </td>
                    ...
                    <td className="px-6 py-4 text-sm text-[#1a1a1a] font-bold text-center">
                      {item.bookings}
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        <IconButton
                          icon={<RiEyeLine />}
                          color="hover:text-[#1E5EFF] hover:bg-blue-50"
                        />
                        <IconButton
                          icon={<RiEditLine />}
                          color="hover:text-[#16A34A] hover:bg-green-50"
                        />
                        <IconButton
                          icon={<RiDeleteBin7Line />}
                          color="hover:text-[#DC2626] hover:bg-red-50"
                        />
                      </div>
                    </td>
                  </tr>
                ...
                <tr>
                  <td
                    colSpan="8"
                    className="px-6 py-12 text-center text-[#6B7280] font-medium"
                  >
