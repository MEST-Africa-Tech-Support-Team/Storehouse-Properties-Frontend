              ...
              {[
                ...
                <div key={idx} className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 ${prop.color} rounded-lg flex items-center justify-center`}
                    >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-[#16A34A] font-extrabold uppercase tracking-tight">
                      Revenue
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#FEF2F2] p-5 rounded-xl border border-red-50">
                ...
                <p className="text-sm text-[#DC2626] font-bold mt-1">
                  0 bookings in 30 days
                </p>
                <a
                  href="#"
                  className="text-[#1E5EFF] text-sm font-bold flex items-center gap-2 mt-3 hover:underline"
                >
              ...
              <div className="bg-[#FFFBEB] p-5 rounded-xl border border-amber-50">
                ...
                <p className="text-sm text-[#D97706] font-bold mt-1">
                  2 bookings in 30 days
                </p>
                <a
                  href="#"
                  className="text-[#1E5EFF] text-sm font-bold flex items-center gap-2 mt-3 hover:underline"
