...
const Button = React.forwardRef(
  ({ 
    ...
    const variants = {
      primary: 'bg-primary hover:bg-hover text-white shadow-primary',
      outline: 'border border-primary text-primary hover:bg-light-primary/20',
      ghost: 'text-primary hover:bg-light-primary/20',
